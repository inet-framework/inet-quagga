...
extern enum filter_type distribute_apply_in (struct interface_FOO *, struct prefix *);
extern enum filter_type distribute_apply_out (struct interface_FOO *, struct prefix *);
