...
struct cmd_node restricted_node_lib =
{
  RESTRICTED_NODE,
  "%s$ ",
};
...
#undef	config_log_timestamp_precision_cmd
...
#define	config_log_timestamp_precision_cmd	config_log_timestamp_precision_cmd__VAR

#undef	no_config_log_timestamp_precision_cmd
...
#define	no_config_log_timestamp_precision_cmd	no_config_log_timestamp_precision_cmd__VAR

#undef	banner_motd_file_cmd
...
#define	banner_motd_file_cmd	banner_motd_file_cmd__VAR
