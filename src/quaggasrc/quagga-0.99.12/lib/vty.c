...
#define	vty_restricted_mode_cmd	vty_restricted_mode_cmd__VAR

#undef	vty_no_restricted_mode_cmd
...
#define	vty_no_restricted_mode_cmd	vty_no_restricted_mode_cmd__VAR
...
ALIAS (terminal_no_monitor,
       ...
       "Set terminal line parameters\n"
       "Copy debug output to the current terminal line\n");
#define	no_terminal_monitor_cmd	no_terminal_monitor_cmd__VAR
