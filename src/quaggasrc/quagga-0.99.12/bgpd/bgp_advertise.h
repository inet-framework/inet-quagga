...
/* Prototypes.  */
extern void bgp_adj_out_set (struct_bgp_node *, struct peer *, struct prefix *,
		      struct attr *, afi_t, safi_t, struct bgp_info *);
extern void bgp_adj_out_unset (struct_bgp_node *, struct peer *, struct prefix *,
			afi_t, safi_t);
extern void bgp_adj_out_remove (struct_bgp_node *, struct bgp_adj_out *, 
			 struct peer *, afi_t, safi_t);
extern int bgp_adj_out_lookup (struct peer *, struct prefix *, afi_t, safi_t,
			struct_bgp_node *);

extern void bgp_adj_in_set (struct_bgp_node *, struct peer *, struct attr *);
extern void bgp_adj_in_unset (struct_bgp_node *, struct peer *);
extern void bgp_adj_in_remove (struct_bgp_node *, struct bgp_adj_in *);
