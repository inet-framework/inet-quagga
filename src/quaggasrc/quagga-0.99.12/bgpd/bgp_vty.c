...
#undef	no_bgp_graceful_restart_stalepath_time_cmd
...
#define	no_bgp_graceful_restart_stalepath_time_cmd	no_bgp_graceful_restart_stalepath_time_cmd__VAR

#undef	no_bgp_graceful_restart_stalepath_time_val_cmd
ALIAS (no_bgp_graceful_restart_stalepath_time,
       ...
       "Set the max time to hold onto restarting peer's stale paths\n"
       "Delay value (seconds)\n");
#define	no_bgp_graceful_restart_stalepath_time_val_cmd	no_bgp_graceful_restart_stalepath_time_val_cmd__VAR
...
#undef	bgp_bestpath_aspath_confed_cmd
...
#define	bgp_bestpath_aspath_confed_cmd	bgp_bestpath_aspath_confed_cmd__VAR

#undef	no_bgp_bestpath_aspath_confed_cmd
...
#define	no_bgp_bestpath_aspath_confed_cmd	no_bgp_bestpath_aspath_confed_cmd__VAR

...
#define	neighbor_password_cmd	neighbor_password_cmd__VAR

#undef	no_neighbor_password_cmd
...
#define	no_neighbor_password_cmd	no_neighbor_password_cmd__VAR

...
#undef	neighbor_disable_connected_check_cmd
...
#define	neighbor_disable_connected_check_cmd	neighbor_disable_connected_check_cmd__VAR

#undef	no_neighbor_disable_connected_check_cmd
...
#define	no_neighbor_disable_connected_check_cmd	no_neighbor_disable_connected_check_cmd__VAR
...
#undef	neighbor_maximum_prefix_restart_cmd
...
#define	neighbor_maximum_prefix_restart_cmd	neighbor_maximum_prefix_restart_cmd__VAR

#undef	neighbor_maximum_prefix_threshold_restart_cmd
...
#define	neighbor_maximum_prefix_threshold_restart_cmd	neighbor_maximum_prefix_threshold_restart_cmd__VAR
...
#undef	no_neighbor_maximum_prefix_threshold_cmd
ALIAS (no_neighbor_maximum_prefix,
       ...
       "maximum no. of prefix limit\n"
       "Threshold value (%) at which to generate a warning msg\n");
#define	no_neighbor_maximum_prefix_threshold_cmd	no_neighbor_maximum_prefix_threshold_cmd__VAR

#undef	no_neighbor_maximum_prefix_warning_cmd
ALIAS (no_neighbor_maximum_prefix,
       ...
       "maximum no. of prefix limit\n"
       "Only give warning message when limit is exceeded\n");
#define	no_neighbor_maximum_prefix_warning_cmd	no_neighbor_maximum_prefix_warning_cmd__VAR

#undef	no_neighbor_maximum_prefix_threshold_warning_cmd
ALIAS (no_neighbor_maximum_prefix,
       ...
       "Threshold value (%) at which to generate a warning msg\n"
       "Only give warning message when limit is exceeded\n");
#define	no_neighbor_maximum_prefix_threshold_warning_cmd	no_neighbor_maximum_prefix_threshold_warning_cmd__VAR

#undef	no_neighbor_maximum_prefix_restart_cmd
ALIAS (no_neighbor_maximum_prefix,
       ...
       "Restart bgp connection after limit is exceeded\n"
       "Restart interval in minutes");
#define	no_neighbor_maximum_prefix_restart_cmd	no_neighbor_maximum_prefix_restart_cmd__VAR

#undef	no_neighbor_maximum_prefix_threshold_restart_cmd
ALIAS (no_neighbor_maximum_prefix,
       ...
       "Restart bgp connection after limit is exceeded\n"
       "Restart interval in minutes");
#define	no_neighbor_maximum_prefix_threshold_restart_cmd	no_neighbor_maximum_prefix_threshold_restart_cmd__VAR

/* "neighbor allowas-in" */
...
#undef	address_family_ipv6_safi_cmd
...
#define	address_family_ipv6_safi_cmd	address_family_ipv6_safi_cmd__VAR
...
#define	show_bgp_memory_cmd	show_bgp_memory_cmd__VAR
...
bgp_show_peer (struct vty *vty, struct peer *p)
{
  ...
  if (CHECK_FLAG (p->sflags, PEER_STATUS_PREFIX_OVERFLOW))
	...
	vty_out (vty, "  Reduce the no. of prefix from %s, will restart in %ld seconds%s",
		 p->host__item, thread_timer_remain_second (p->t_pmax_restart),
		 VTY_NEWLINE);
      else
...
struct cmd_node bgp_ipv6_multicast_node_bgpd =
{
  BGP_IPV6M_NODE,
  "%s(config-router-af)# ",
  1,
...
#undef	no_ip_community_list_standard_all_cmd
...
#define	no_ip_community_list_standard_all_cmd	no_ip_community_list_standard_all_cmd__VAR

#undef	no_ip_community_list_expanded_all_cmd
...
#define	no_ip_community_list_expanded_all_cmd	no_ip_community_list_expanded_all_cmd__VAR

#undef	no_ip_community_list_name_standard_all_cmd
...
#define	no_ip_community_list_name_standard_all_cmd	no_ip_community_list_name_standard_all_cmd__VAR

#undef	no_ip_community_list_name_expanded_all_cmd
...
#define	no_ip_community_list_name_expanded_all_cmd	no_ip_community_list_name_expanded_all_cmd__VAR
...
#undef	no_ip_extcommunity_list_standard_all_cmd
...
#define	no_ip_extcommunity_list_standard_all_cmd	no_ip_extcommunity_list_standard_all_cmd__VAR

#undef	no_ip_extcommunity_list_expanded_all_cmd
...
#define	no_ip_extcommunity_list_expanded_all_cmd	no_ip_extcommunity_list_expanded_all_cmd__VAR

#undef	no_ip_extcommunity_list_name_standard_all_cmd
...
#define	no_ip_extcommunity_list_name_standard_all_cmd	no_ip_extcommunity_list_name_standard_all_cmd__VAR

#undef	no_ip_extcommunity_list_name_expanded_all_cmd
...
#define	no_ip_extcommunity_list_name_expanded_all_cmd	no_ip_extcommunity_list_name_expanded_all_cmd__VAR
