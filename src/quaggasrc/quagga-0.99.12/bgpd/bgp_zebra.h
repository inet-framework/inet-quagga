...
extern struct interface_FOO *if_lookup_by_ipv4 (struct in_addr *);
extern struct interface_FOO *if_lookup_by_ipv4_exact (struct in_addr *);
#ifdef HAVE_IPV6
extern struct interface_FOO *if_lookup_by_ipv6 (struct in6_addr *);
extern struct interface_FOO *if_lookup_by_ipv6_exact (struct in6_addr *);
#endif /* HAVE_IPV6 */
