...
extern void bgp_info_add (struct_bgp_node *rn, struct bgp_info *ri);
extern void bgp_info_delete (struct_bgp_node *rn, struct bgp_info *ri);
extern struct bgp_info_extra *bgp_info_extra_get (struct bgp_info *);
extern void bgp_info_set_flag (struct_bgp_node *, struct bgp_info *, u_int32_t);
extern void bgp_info_unset_flag (struct_bgp_node *, struct bgp_info *, u_int32_t);
...
extern void bgp_process (struct bgp *, struct_bgp_node *, afi_t, safi_t);
