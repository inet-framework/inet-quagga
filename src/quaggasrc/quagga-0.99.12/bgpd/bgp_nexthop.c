...
static struct thread *bgp_scan_thread_bgpd ;

/* BGP import thread */
static struct thread *bgp_import_thread_bgpd ;

/* BGP scan interval. */
static int bgp_scan_interval_bgpd;

/* BGP import interval. */
static int bgp_import_interval_bgpd;

/* Route table for next-hop lookup cache. */
static struct bgp_table *bgp_nexthop_cache_table_bgpd[AFI_MAX];
static struct bgp_table *cache1_table_bgpd[AFI_MAX];
static struct bgp_table *cache2_table_bgpd[AFI_MAX];

/* Route table for connected route. */
static struct bgp_table *bgp_connected_table_bgpd[AFI_MAX];
