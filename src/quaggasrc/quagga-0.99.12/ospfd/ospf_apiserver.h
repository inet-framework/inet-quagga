...
extern struct ospf_interface *ospf_apiserver_if_lookup_by_addr (struct in_addr
							 address);
extern struct ospf_interface *ospf_apiserver_if_lookup_by_ifp (struct interface_FOO
							*ifp);
...
extern int ospf_apiserver_new_if (struct interface_FOO *ifp);
extern int ospf_apiserver_del_if (struct interface_FOO *ifp);
...
extern void ospf_apiserver_config_write_if (struct vty *vty, struct interface_FOO *ifp);
