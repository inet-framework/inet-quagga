...
ospf_passive_interface_default (struct ospf *ospf, u_char newval)
{
  ...
  for (ALL_LIST_ELEMENTS_RO (om->iflist__item, ln, ifp))
    {
      if (ifp &&
...
static void
ospf_passive_interface_update (struct ospf *ospf, struct interface_FOO *ifp,
                               struct in_addr addr, 
...
#undef	ospf_passive_interface_default_cmd
ALIAS (ospf_passive_interface,
       ospf_passive_interface_default_cmd,
       "passive-interface default",
       "Suppress routing updates on an interface\n"
       "Suppress routing updates on interfaces by default\n");
#define	ospf_passive_interface_default_cmd	ospf_passive_interface_default_cmd__VAR
...
#undef	no_ospf_passive_interface_default_cmd
ALIAS (no_ospf_passive_interface,
...
#define	no_ospf_passive_interface_default_cmd	no_ospf_passive_interface_default_cmd__VAR
...
#undef	ospf_log_adjacency_changes_cmd
...
#define	ospf_log_adjacency_changes_cmd	ospf_log_adjacency_changes_cmd__VAR

#undef	ospf_log_adjacency_changes_detail_cmd
...
#define	ospf_log_adjacency_changes_detail_cmd	ospf_log_adjacency_changes_detail_cmd__VAR

#undef	no_ospf_log_adjacency_changes_cmd
...
#define	no_ospf_log_adjacency_changes_cmd	no_ospf_log_adjacency_changes_cmd__VAR

#undef	no_ospf_log_adjacency_changes_detail_cmd
...
#define	no_ospf_log_adjacency_changes_detail_cmd	no_ospf_log_adjacency_changes_detail_cmd__VAR
...
#undef	ospf_timers_throttle_spf_cmd
...
#define	ospf_timers_throttle_spf_cmd	ospf_timers_throttle_spf_cmd__VAR
...
#undef	no_ospf_timers_throttle_spf_cmd
       ...
       "The reference bandwidth in terms of Mbits per second\n")
{
  ...
  for (ALL_LIST_ELEMENTS_RO (om->iflist__item, node, ifp))
       ...
       "Use reference bandwidth method to assign OSPF cost\n")
{
  ...
  for (ALL_LIST_ELEMENTS (om->iflist__item, node, nnode, ifp))
    ospf_if_recalculate_output_cost (ifp);
...
ALIAS (ip_ospf_cost,
       ...
       "Interface cost\n"
       "Cost");
#define	ip_ospf_cost_u32_cmd	ip_ospf_cost_u32_cmd__VAR
...
ALIAS (ip_ospf_cost,
       ...
       "Cost\n"
       "Address of interface");
#define	ospf_cost_u32_inet4_cmd	ospf_cost_u32_inet4_cmd__VAR

#undef	no_ip_ospf_cost_inet4_cmd
...
#define	no_ip_ospf_cost_inet4_cmd	no_ip_ospf_cost_inet4_cmd__VAR
...
ALIAS (no_ip_ospf_cost,
       ...
       "Interface cost\n"
       "Address of interface");
#define	no_ospf_cost_inet4_cmd	no_ospf_cost_inet4_cmd__VAR
...
#undef	ip_ospf_dead_interval_minimal_cmd
ALIAS (ip_ospf_dead_interval_minimal,
       ...
       "Hello multiplier factor\n"
       "Number of Hellos to send each second\n");
#define	ip_ospf_dead_interval_minimal_cmd	ip_ospf_dead_interval_minimal_cmd__VAR
...
#undef	ip_ospf_mtu_ignore_addr_cmd
...
#define	ip_ospf_mtu_ignore_addr_cmd	ip_ospf_mtu_ignore_addr_cmd__VAR

#undef	ip_ospf_mtu_ignore_cmd
ALIAS (ip_ospf_mtu_ignore,
      ...
      "OSPF interface commands\n"
      "Disable mtu mismatch detection\n");
#define	ip_ospf_mtu_ignore_cmd	ip_ospf_mtu_ignore_cmd__VAR

    
#undef	no_ip_ospf_mtu_ignore_addr_cmd
...
#define	no_ip_ospf_mtu_ignore_addr_cmd	no_ip_ospf_mtu_ignore_addr_cmd__VAR

#undef	no_ip_ospf_mtu_ignore_cmd
ALIAS (no_ip_ospf_mtu_ignore,
      ...
      "OSPF interface commands\n"
      "Disable mtu mismatch detection\n");
#define	no_ip_ospf_mtu_ignore_cmd	no_ip_ospf_mtu_ignore_cmd__VAR

#undef	ospf_max_metric_router_lsa_admin_cmd
...
#define	ospf_max_metric_router_lsa_admin_cmd	ospf_max_metric_router_lsa_admin_cmd__VAR

#undef	no_ospf_max_metric_router_lsa_admin_cmd
...
#define	no_ospf_max_metric_router_lsa_admin_cmd	no_ospf_max_metric_router_lsa_admin_cmd__VAR

#undef	ospf_max_metric_router_lsa_startup_cmd
...
#define	ospf_max_metric_router_lsa_startup_cmd	ospf_max_metric_router_lsa_startup_cmd__VAR

#undef	no_ospf_max_metric_router_lsa_startup_cmd
...
#define	no_ospf_max_metric_router_lsa_startup_cmd	no_ospf_max_metric_router_lsa_startup_cmd__VAR

#undef	ospf_max_metric_router_lsa_shutdown_cmd
...
#define	ospf_max_metric_router_lsa_shutdown_cmd	ospf_max_metric_router_lsa_shutdown_cmd__VAR

#undef	no_ospf_max_metric_router_lsa_shutdown_cmd
...
#define	no_ospf_max_metric_router_lsa_shutdown_cmd	no_ospf_max_metric_router_lsa_shutdown_cmd__VAR
