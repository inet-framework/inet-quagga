...
extern struct ospf_interface *ospf_if_new (struct ospf *, struct interface_FOO *,
					   struct prefix *);
...
extern struct ospf_if_params *ospf_lookup_if_params (struct interface_FOO *,
						     struct in_addr);
extern struct ospf_if_params *ospf_get_if_params (struct interface_FOO *,
						  struct in_addr);
extern void ospf_del_if_params (struct ospf_if_params *);
extern void ospf_free_if_params (struct interface_FOO *, struct in_addr);
extern void ospf_if_update_params (struct interface_FOO *, struct in_addr);

extern int ospf_if_new_hook (struct interface_FOO *);
...
extern void ospf_if_recalculate_output_cost (struct interface_FOO *);

/* Simulate down/up on the interface. */
extern void ospf_if_reset (struct interface_FOO *);
...
extern u_char ospf_default_iftype (struct interface_FOO *ifp);
