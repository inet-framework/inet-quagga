...
static struct list *rip_offset_list_master_ripd;
...
int
rip_offset_list_apply_in (struct prefix_ipv4 *p, struct interface_FOO *ifp,
			  u_int32_t *metric)
{
  struct rip_offset_list *offset;
  struct access_list *alist;
...
/* If metric is modifed return 1. */
int
rip_offset_list_apply_out (struct prefix_ipv4 *p, struct interface_FOO *ifp,
			  u_int32_t *metric)
{
  struct rip_offset_list *offset;
  struct access_list *alist;
