...

/* static prototypes */
static void rip_enable_apply (struct interface_FOO *);
static void rip_passive_interface_apply (struct interface_FOO *);
static int rip_if_down(struct interface_FOO *ifp);
