...
extern int rip_request_send (struct sockaddr_in *, struct interface_FOO *, u_char,
                      struct connected *);
...
extern void rip_distribute_update_interface (struct interface_FOO *);
extern void rip_if_rmap_update_interface (struct interface_FOO *);
...
extern int rip_offset_list_apply_in (struct prefix_ipv4 *, struct interface_FOO *, u_int32_t *);
extern int rip_offset_list_apply_out (struct prefix_ipv4 *, struct interface_FOO *, u_int32_t *);
...
extern void rip_ifaddr_add (struct interface_FOO *, struct connected *);
extern void rip_ifaddr_delete (struct interface_FOO *, struct connected *);
