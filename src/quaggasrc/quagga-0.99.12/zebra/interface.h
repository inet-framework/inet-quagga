...
extern void if_delete_update (struct interface_FOO *ifp);
extern void if_add_update (struct interface_FOO *ifp);
extern void if_up (struct interface_FOO *);
extern void if_down (struct interface_FOO *);
extern void if_refresh (struct interface_FOO *);
extern void if_flags_update (struct interface_FOO *, uint64_t);
extern int if_subnet_add (struct interface_FOO *, struct connected *);
extern int if_subnet_delete (struct interface_FOO *, struct connected *);
...
#ifdef BSDI
extern int if_kvm_get_mtu (struct interface_FOO *);
#endif /* BSDI */
