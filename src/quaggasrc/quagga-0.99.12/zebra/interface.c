...
int
if_subnet_add (struct interface_FOO *ifp, struct connected *ifc)
{
...
int
if_subnet_delete (struct interface_FOO *ifp, struct connected *ifc)
{
  struct route_node *rn;
  struct zebra_if *zebra_if;
  struct list *addr_list;
 ...
 */
static inline void
if_flags_mangle (struct interface_FOO *ifp, uint64_t *newflags)
{
#ifdef SUNOS_5
 ...
 */
void
if_flags_update (struct interface_FOO *ifp, uint64_t newflags)
{
...
#define	show_interface_desc_cmd	show_interface_desc_cmd__VAR
