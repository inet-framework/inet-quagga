...
irdp_get_prefix(struct interface_FOO *ifp)
{
...
static int
if_group (struct interface_FOO *ifp, 
	  int sock, 
	  u_int32_t group, 
	  int add_leave)
{
...
static int
if_add_group (struct interface_FOO *ifp)
{
...
static int
if_drop_group (struct interface_FOO *ifp)
{
  struct zebra_if *zi= ifp->info;
  struct irdp_interface *irdp = &zi->irdp;
  int ret;
...
static void
irdp_if_start(struct interface_FOO *ifp, int multicast, int set_defaults)
{
  struct zebra_if *zi= ifp->info;
  struct irdp_interface *irdp = &zi->irdp;
  struct listnode *node;
...
static void
irdp_if_stop(struct interface_FOO *ifp)
{
  struct zebra_if *zi=ifp->info;
  struct irdp_interface *irdp=&zi->irdp;
...
static void
irdp_if_shutdown(struct interface_FOO *ifp)
{
  struct zebra_if *zi= ifp->info;
  struct irdp_interface *irdp = &zi->irdp;
...
static void
irdp_if_no_shutdown(struct interface_FOO *ifp)
{
  struct zebra_if *zi= ifp->info;
  struct irdp_interface *irdp = &zi->irdp;
