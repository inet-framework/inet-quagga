...
static void
connected_announce (struct interface_FOO *ifp, struct connected *ifc)
{
  if (!ifc)
    return;
...
connected_implicit_withdraw (struct interface_FOO *ifp, struct connected *ifc)
{
...
void
connected_add_ipv6 (struct interface_FOO *ifp, int flags, struct in6_addr *addr,
