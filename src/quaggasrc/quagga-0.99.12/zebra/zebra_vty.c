...
char *proto_rm_zebra[AFI_MAX][ZEBRA_ROUTE_MAX+1];	/* "any" == ZEBRA_ROUTE_MAX */

#undef	ip_protocol_cmd
DEFUN (ip_protocol,
       ip_protocol_cmd,
...
#define	ip_protocol_cmd	ip_protocol_cmd__VAR
...
#define	show_ip_protocol_cmd	show_ip_protocol_cmd__VAR
...
struct cmd_node protocol_node_zebra ;
