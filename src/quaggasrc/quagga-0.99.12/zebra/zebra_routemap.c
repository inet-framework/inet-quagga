...
struct route_map_rule_cmd route_match_interface_cmd_zebra =
{
   "interface",
...
#define	set_src_cmd	set_src_cmd__VAR

#undef	no_set_src_cmd
DEFUN (no_set_src,
       no_set_src_cmd,
       "no set src",
       NO_STR
...
#define	no_set_src_cmd	no_set_src_cmd__VAR

#undef	no_set_src_val_cmd
ALIAS (no_set_src,
       no_set_src_val_cmd,
       "no set src (A.B.C.D)",
       NO_STR
       ...
       "src address for route\n"
       "src address\n");
#define	no_set_src_val_cmd	no_set_src_val_cmd__VAR
