...
extern void zebra_interface_up_update (struct interface_FOO *);
extern void zebra_interface_down_update (struct interface_FOO *);

extern void zebra_interface_add_update (struct interface_FOO *);
extern void zebra_interface_delete_update (struct interface_FOO *);

extern void zebra_interface_address_add_update (struct interface_FOO *,
					 	struct connected *);
extern void zebra_interface_address_delete_update (struct interface_FOO *,
						   struct connected *c);
